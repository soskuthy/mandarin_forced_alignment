...
```{r plot box plot}
p_log_2 <- ggplot(df, aes(y=diff*1000, x=res, color=res, shade=speaker)) +
  #scale_color_manual(values = c("dodgerblue2", "darkgoldenrod2", 
  #                              "coral2", "coral2",
  #                              "dodgerblue2","darkgoldenrod2",
  #                              "seagreen", "seashell",
...
ggsave(p_log_2, filename = "Mandarin_log_2.png",  width = 9, height = 5, bg = "transparent")
...
p <- ggplot(df, aes(y=diff*1000, x=res, color=res, shade=speaker)) +
  # using violins to show distributions per vowel
...
ggsave(p, filename = "graphs/Mandarin_by_speaker.png",  width = 9, height = 5, bg = "transparent")
...
ggsave(p_study, filename = "percentage.png",  width = 9, height = 5, bg = "transparent")
...
manual_suyuan <- subset(manual, res%in%c("Beijing","Shanghai","Canto"))
...
ggsave(filename = "Mandarin_manual_by_speaker.png",  width = 9, height = 5, bg = "transparent")
```
...
ggsave(filename = "Mandarin_manual_by_variety.png",  width = 9, height = 5, bg = "transparent")
```
